...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| R01 | Interpretação de relatos leigos e classificação inicial de urgência | Tutor precisa descrever os sinais e compreender a possível gravidade do caso — H01 e H02 | P01 e P02 | C01 e C03 — Entrega 4 | A01, A03 e A04 da Entrega 1; tarefas T ainda PENDENTES | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Entrega 3: priorizar linguagem cotidiana, correção do relato, urgência compreensível e próximo passo acionável |
...
| R05 | Geração e compartilhamento de resumo estruturado | Tutor e clínica podem precisar organizar as informações do caso antes da chegada — H03 e H05 | P01 e P03 | C02 — Entrega 4 | A06 da Entrega 1; tarefa T PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | PENDENTE | Entrega 3: preservar relato original, distinguir conteúdo automático e exigir revisão, consentimento e confirmação da clínica |
